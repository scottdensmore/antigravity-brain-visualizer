...
/** Normalizes a pushed OpenAI Codex rollout, reusing {@link CodexAdapter}. */
@Singleton
public class CodexNormalizer implements SourceNormalizer {
    ...
    public String toStepsJson(List<String> rawLines) {
        return CodexAdapter.toTranscriptJson(rawLines);
    }

    @Override
    public Optional<String> deriveTitle(List<String> rawLines) {
        return CodexAdapter.deriveSummary(rawLines);
    }
}
